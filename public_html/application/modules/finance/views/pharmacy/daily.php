            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h1 class="display-4 font-weight-black mb-0">
                        ...
                        <?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('sales_report'); ?>
                    </h1>
                ...
                <div class="col-sm-6 text-right">
                    <a href="finance/pharmacy/daily?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>" class="btn btn-warning btn-sm px-4 py-3 mr-2">
                        <i class="fa fa-arrow-left"></i> <?php echo lang('previous_month'); ?>
                    </a>
                    <a href="finance/pharmacy/daily?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>" class="btn btn-success btn-sm px-4 py-3 mr-2">
                        <i class="fa fa-arrow-right"></i> <?php echo lang('next_month'); ?>
                    </a>
                ...
                <div class="col-md-8">
                    <div class="card shadow-lg border-0">
                        <div class="card-header">
                            <h3 class="card-title text-black font-weight-800"><?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('sales_report'); ?></h3>
                        </div>
