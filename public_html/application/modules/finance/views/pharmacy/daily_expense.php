...
<div class="content-wrapper bg-light appointment-page">
    ...
    $CI->load->view('partials/page_header', array(
        'title' => date('F, Y', $first_minute) . ' — ' . lang('pharmacy') . ' ' . lang('expense_report'),
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm border-0 appointment-list-card">
                        <div class="card-header bg-white border-bottom py-3">
                            <h3 class="card-title h6 mb-0 text-muted text-uppercase"><?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('expense_report'); ?></h3>
                        </div>
