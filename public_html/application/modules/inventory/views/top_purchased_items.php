                                        ...
                                        <?php if (!empty($items)) { ?>
                                            ...
                                            <?php foreach ($items as $item) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="ap-status ap-status-info"><?php echo htmlspecialchars($item->category_name); ?></span>
                                                    </td>
                                                    <td class="font-weight-bold text-primary">
                                                        <?php echo number_format($item->total_quantity); ?> <?php echo $item->unit; ?>
                                                    </td>
                                                    <td>
                                                        <span class="ap-status ap-status-success"><?php echo number_format($item->total_orders); ?></span>
                                                    </td>
