...
<div class="content-wrapper">
    <section class="content-header"><h1>Chamber locations</h1></section>
    <section class="content">
        ...
        <div class="card card-outline card-primary mb-3">
            <div class="card-header"><h3 class="card-title">Add chamber</h3></div>
            <div class="card-body">
                <form method="post" action="<?php echo site_url('doctor_chamber/chamber_create'); ?>">
                    ...
                    <button class="btn btn-primary" type="submit">Create chamber</button>
                </form>
            </div>
        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="post" action="<?php echo site_url('doctor_chamber/chamber_update'); ?>">
                    ...
                    <button class="btn btn-primary" type="submit">Save chamber</button>
                </form>
            </div>
        </div>
        <?php endforeach; ?>
        <?php if (empty($rows)) : ?>
            <p class="text-muted">No chambers found.</p>
        <?php endif; ?>
        <p><a href="<?php echo site_url('doctor_chamber/schedule_exceptions'); ?>">Vacation / closed dates</a></p>
    </section>
</div>
