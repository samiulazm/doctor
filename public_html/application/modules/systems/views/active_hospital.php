            ...
            <div class="row align-items-center pl-1">
                <div class="col-12 col-lg-9">
                    ...
                    <h1 class="display-4 font-weight-black mb-0">
                        <i class="fas fa-hospital mr-2 ap-settings-saas-report-hero-icon"></i><?php echo lang('active_hospitals'); ?>
                    </h1>
                ...
                <div class="col-12">
                    <div class="card <?php echo $ap_settings_saas_ui ? 'ap-settings-saas-systems-report border-0 shadow' : ''; ?>">
                        <div class="card-header <?php echo $ap_settings_saas_ui ? 'ap-settings-saas-systems-card-hd' : ''; ?>">
                            <h3 class="card-title mb-0"><?php echo lang('All the active hospitals names and related informations'); ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
