...
$CI = get_instance();
if (!isset($accountant)) {
    $accountant = (object) array();
}
$t = !empty($accountant->id) ? lang('edit_accountant') : lang('add_accountant');
?>
...
<div class="content-wrapper bg-light appointment-page">
    ...
    $CI->load->view('partials/page_header', array(
        ...
        'breadcrumbs' => array(
            ...
            array('label' => lang('accountant'), 'url' => 'accountant'),
                            ...
                            <form role="form" action="accountant/addNew" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    if (!empty($accountant->name)) {
                                        echo html_escape($accountant->name);
                                    }
                                    ?>" required="">
                                </div>
                                <div class="form-group">
                                    ...
                                    if (!empty($accountant->email)) {
                                        echo html_escape($accountant->email);
                                    }
                                    ?>" required="">
                                </div>
                                <div class="form-group">
                                    <label><?php echo lang('password'); ?> <?php if (empty($accountant->id)) { ?> &ast; <?php } ?> </label>
                                    <input type="password" class="form-control form-control-lg" name="password" placeholder="********" <?php if (empty($accountant->id)) { ?> required="" <?php } ?>>
                                </div>
                                <div class="form-group">
                                    ...
                                    if (!empty($accountant->address)) {
                                        echo html_escape($accountant->address);
                                    }
                                    ?>" required="">
                                </div>
                                <div class="form-group">
                                    ...
                                    if (!empty($accountant->phone)) {
                                        echo html_escape($accountant->phone);
                                    }
                                    ?>" required="">
                                </div>
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail img_class fileupload-preview fileupload-exists thumbnail img_thumb">
                                                ...
                                                if (!empty($accountant->signature)) {
                                                    echo html_escape($accountant->signature);
                                                }
                                                ?>" height="100" alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail img_class fileupload-preview fileupload-exists thumbnail img_thumb">
                                                ...
                                                if (!empty($accountant->img_url)) {
                                                    echo html_escape($accountant->img_url);
                                                }
                                                ?>" height="100" alt="">
                                            </div>
                                            <div>
