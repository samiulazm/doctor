                        ...
                        <div class="card shadow-lg custom-rounded m-2 mb-3">
                            <div class="p-3">
                                ...
                                <script type="text/javascript">
                                    ...
                                    google.charts.setOnLoadCallback(drawChartTopServices);

                                    function drawChartTopServices() {
                                        var data = google.visualization.arrayToDataTable([
                                            ['Service', 'Revenue'],
                                            <?php
                        ...
                        <div class="card shadow-lg custom-rounded m-2 mb-3">
                            <div class="p-3">
                                ...
                                <script type="text/javascript">
                                    ...
                                    google.charts.setOnLoadCallback(drawChartTopDiagnoses);

                                    function drawChartTopDiagnoses() {
                                        var data = google.visualization.arrayToDataTable([
                                            ['Diagnosis', 'Patients'],
                                            <?php
                        ...
                        <div class="card shadow-lg custom-rounded m-2 mb-3">
                            <div class="p-3">
                                ...
                                <script type="text/javascript">
                                    ...
                                    google.charts.setOnLoadCallback(drawChartBedOccupancy);

                                    function drawChartBedOccupancy() {
                                        var data = google.visualization.arrayToDataTable([
                                            ['Status', 'Count'],
                        ...
                        <div class="card shadow-lg custom-rounded m-2 mb-3">
                            <div class="p-3">
                                ...
                                <script type="text/javascript">
                                    ...
                                    google.charts.setOnLoadCallback(drawChartTopTreatments);

                                    function drawChartTopTreatments() {
                                        var data = google.visualization.arrayToDataTable([
                                            ['Treatment', 'Patients'],
                                            <?php
