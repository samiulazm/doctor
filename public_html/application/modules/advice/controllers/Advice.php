    ...
    function getAdviceList()
    {
        ...
        foreach ($data['advices'] as $advice) {
            ...
            if ($this->ion_auth->in_group(array('admin'))) {
                ...
                $options5 = '<a class="btn btn-danger btn-sm delete_button" title="' . lang('delete') . '" href="advice/delete?id=' . $advice->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash"></i> ' . lang('delete') . '</a>';
            }
