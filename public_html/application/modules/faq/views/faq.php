            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table class="table table-bordered table-hover" id="dt-faq" data-legacy-table="editable-sample">
                                <thead>
                                    <tr>
                                    ...
                                    <?php foreach ($faqs as $faq) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print d-flex gap-1">
                                                <a type="button" class="btn btn-primary btn-sm btn_width editbutton" title="<?php echo lang('edit'); ?>" data-bs-toggle="modal" data-id="<?php echo $faq->id; ?>"><i class="fa fa-edit"> </i></a>
