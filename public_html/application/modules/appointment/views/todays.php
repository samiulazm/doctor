...
<div class="content-wrapper bg-light appointment-page">
    ...
    $CI->load->view('partials/page_header', array(
        'title' => lang('todays_appointments'),
        'icon' => 'fas fa-calendar-day text-primary mr-2',
        'breadcrumbs' => array(
            array('label' => lang('home'), 'url' => 'home'),
            array('label' => lang('appointment'), 'url' => 'appointment'),
            array('label' => lang('todays_appointments'), 'url' => null),
        ),
    ));
    ?>
                ...
                <div class="col-md-12">
                    <div class="card shadow-sm border-0 appointment-list-card">
                        <div class="card-header bg-white border-bottom d-flex flex-wrap align-items-center justify-content-between gap-2 py-3">
                            <h3 class="card-title h6 mb-0 text-muted text-uppercase"><?php echo lang('All the the todays appointments'); ?></h3>
