                ...
                <div class="col-md-12">
                    <div class="card shadow-sm border-0 appointment-list-card">
                        <div class="card-header bg-white border-bottom d-flex flex-wrap align-items-center justify-content-between gap-2 py-3">
                            <h3 class="card-title h6 mb-0 text-muted text-uppercase"><?php echo lang('All the upcoming appointments'); ?></h3>
                        ...
                        <div class="card-body p-4">
                            ...
                            <table class="table table-hover table-bordered align-middle datatables mb-0" id="editable-sample1" width="100%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="sendSmsToVolunteer" action="sms/appointmentReminder" method="post" enctype="multipart/form-data">
                    ...
                    <button type="button" class="btn btn-info invoicebutton" data-dismiss="modal"><?php echo lang('cancel'); ?></button>
                </form>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
