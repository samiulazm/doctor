...
<div class="content-wrapper bg-light appointment-page">
    ...
    $CI->load->view('partials/page_header', array(
        'title' => lang('gallery'),
        'icon' => 'fas fa-images text-primary mr-2',
        'breadcrumbs' => array(
            array('label' => lang('home'), 'url' => 'home'),
            array('label' => lang('gallery'), 'url' => null),
        ),
    ));
    ?>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0 appointment-list-card">
                        <div class="card-header bg-white border-bottom py-3">
                            <h3 class="card-title h6 mb-0 text-muted text-uppercase"><?php echo lang('All the gallery names and related informations'); ?></h3>
                        </div>
                                ...
                                <table class="table table-bordered table-hover align-middle text-sm datatables mb-0" id="dt-site" data-legacy-table="editable-sample" width="100%">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="text-uppercase"><?php echo lang('position'); ?></th>
                                        ...
                                        <?php foreach ($gallerys as $row) { ?>
                                            <tr>
                                                <td class="align-middle">
                                                    <img class="img-fluid rounded-circle" style="width: 50px; height: 50px;" src="<?php echo html_escape($row->img, ENT_QUOTES, 'UTF-8'); ?>" alt="">
                                                </td>
                                                ...
                                                <td class="no-print text-nowrap">
                                                    ...
                                                    <a class="btn btn-danger btn-sm ml-1" href="site/gallery/delete?id=<?php echo (int) $row->id; ?>"
...
<div class="modal fade" id="myModal" role="dialog" aria-labelledby="addGalleryLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-white font-weight-bold" id="addGalleryLabel"><?php echo lang('add_image'); ?></h4>
            ...
            <div class="modal-body">
                <form role="form" action="site/gallery/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-lg" name="position" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new thumbnail img_class mb-2"><img src="" height="150" alt="" /></div>
...
<div class="modal fade" id="myModal2" role="dialog" aria-labelledby="editGalleryLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-white font-weight-bold" id="editGalleryLabel"><?php echo lang('edit_image'); ?></h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="<?php echo lang('close'); ?>">&times;</button>
            </div>
            <div class="modal-body">
                <form role="form" id="editSlideForm" class="clearfix" action="site/gallery/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label><?php echo lang('status'); ?> <span class="text-danger">*</span></label>
                        <select class="form-control form-control-lg" name="status" required>
                            <option value="Active" <?php echo (!empty($gallery->status) && $gallery->status == 'Active') ? 'selected' : ''; ?>><?php echo lang('active'); ?></option>
                            <option value="Inactive" <?php echo (!empty($gallery->status) && $gallery->status == 'Inactive') ? 'selected' : ''; ?>><?php echo lang('in_active'); ?></option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?php echo lang('image'); ?></label>
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new thumbnail img_class mb-2"><img src="" id="img" height="150" alt="" /></div>
                            <span class="btn btn-white btn-file">
                                <span class="btn fileupload-new badge badge-secondary"><i class="fa fa-paper-clip"></i> <?php echo lang('select_image'); ?></span>
                                <input type="file" class="default" name="img_url">
                            </span>
