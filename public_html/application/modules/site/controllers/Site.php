...
class Site extends MX_Controller
{
    ...
    public function addNew()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            show_swal('warning', lang('form_validation_error'));
            redirect("site");
        } else {
            ...
            if ($patient == 'patient_id') {
                ...
                if (empty($patient_exist)) {
                    show_swal('warning', lang('invalid_patient_id'));
                    redirect("site");
                }
            }
            ...
            if ($patient == 'add_new') {
                ...
                if ($this->ion_auth->email_check($p_email)) {
                    show_swal('warning', lang('this_email_address_is_already_registered'));
                    redirect(safe_ci_redirect($redirect, 'site'));
                } else {
                    $dfg = 5;
            ...
            if (empty($id)) {     // Adding New department
                ...
                if (!empty($pay_now_appointment)) {
                    ...
                    show_swal('success', lang('added'));
                    // show_swal('success', lang('appointment_added_successfully_please_wait_you_will_get_a_confirmation_sms'));
    ...
    public function appointmentPayment($data, $patient, $doctor, $consultant_fee, $date, $inserted_id, $redirectlink)
    {
        ...
        if ($gateway == 'PayPal') {
            ...
            if ($chargeJson['status'] == 'succeeded') {
                ...
                show_swal('feedback', lang('payment_successful'));
            } else {
    ...
    public function update()
    {
        ...
        if (!empty($email)) {
            ...
            show_swal('feedback', lang('email_required'));
