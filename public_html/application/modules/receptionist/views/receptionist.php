...
<div class="content-wrapper bg-light appointment-page">
    ...
    $CI->load->view('partials/page_header', array(
        'title' => lang('receptionist'),
        'icon' => 'fas fa-user-plus text-primary mr-2',
        'breadcrumbs' => array(
            array('label' => lang('home'), 'url' => 'home'),
            array('label' => lang('receptionist'), 'url' => null),
        ),
    ));
    ?>
        ...
        <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-end mb-3">
                <a data-toggle="modal" data-target="#myModal" href="#myModal" class="btn btn-sm btn-success">
                    <i class="fa fa-plus mr-1"></i> <?php echo lang('add_new'); ?> <?php echo lang('receptionist'); ?>
                </a>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0 appointment-list-card">
                        <div class="card-header bg-white border-bottom py-3">
                            <h3 class="card-title h6 mb-0 text-muted text-uppercase"><?php echo lang('receptionist'); ?></h3>
                        </div>
                        <div class="card-body p-4">
                            <div class="custom_buttons mb-3"></div>
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered align-middle text-sm datatables mb-0" id="dt-receptionist" data-legacy-table="editable-sample" width="100%">
                                        ...
                                        <?php foreach ($receptionists as $receptionist) { ?>
                                            <tr>
                                                <td class="align-middle">
                                                    <img class="img-fluid rounded-circle" style="width: 50px; height: 50px;" src="<?php echo html_escape($receptionist->img_url); ?>" alt="">
                                                </td>
                                                <td class="align-middle"><?php echo html_escape($receptionist->name); ?></td>
                                                <td class="align-middle"><?php echo html_escape($receptionist->email); ?></td>
                                                <td class="align-middle"><?php echo html_escape($receptionist->address); ?></td>
                                                <td class="align-middle"><?php echo html_escape($receptionist->phone); ?></td>
                                                <td class="align-middle no-print">
                                                    <a type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-id="<?php echo (int) $receptionist->id; ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm delete_button" href="receptionist/delete?id=<?php echo (int) $receptionist->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('<?php echo lang('are_you_sure_you_want_to_delete_this_item'); ?>');">
...
<div class="modal fade" id="myModal" role="dialog" aria-labelledby="addReceptionistModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h2 class="modal-title text-white font-weight-800" id="addReceptionistModalLabel"><?php echo lang('add_receptionist'); ?></h2>
...
<div class="modal fade" id="myModal2" role="dialog" aria-labelledby="editReceptionistModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h2 class="modal-title text-white font-weight-800" id="editReceptionistModalLabel"><?php echo lang('edit_receptionist'); ?></h2>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="<?php echo lang('close'); ?>">&times;</button>
            </div>
            <div class="modal-body bg-light p-4">
