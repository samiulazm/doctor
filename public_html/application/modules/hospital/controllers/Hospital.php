...
For Any Support Please Contact Us At: {phone}';
    ...
    function getPackageForHospitalRegisteration()
    {
        ...
        $modules = ['accountant', 'appointment', 'chamber_practice', 'lab', 'bed', 'department', 'donor', 'finance', 'pharmacy', 'laboratorist', 'medicine', 'nurse', 'patient', 'pharmacist', 'prescription', 'receptionist', 'report', 'notice', 'email', 'sms', 'file', 'payroll', 'attendance', 'leave', 'chat'];
        ...
        for ($i = 0; $i < count($modules); $i++) {
            if (in_array($modules[$i], $package_in_list)) {
                ...
                } elseif ($modules[$i] == 'chamber_practice') {
                    $option .= '<div class="col-sm-3 bg-white text-white"><i class="fa fa-check text-white"></i> Chamber practice</div>';
                ...
                if ($modules[$i] == 'finance') {
                    ...
                    $option .= '<div class="col-sm-3 bg-white text-white"><i class="fa fa-times text-white"></i> Chamber practice</div>';
                } elseif ($modules[$i] == 'lab') {
