                                    ...
                                    <?php foreach ($gridsections as $gridsection) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print d-flex gap-1">
                                                <a type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-bs-toggle="modal" data-id="<?php echo $gridsection->id; ?>"><i class="fa fa-edit"> </i></a>
