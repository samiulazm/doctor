                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="frontend/featured/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="profile" value='<?php
                                                                                                                            if (!empty($setval)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="editor" name="description" value='<?php
                                                                                                                                            if (!empty($setval)) {
