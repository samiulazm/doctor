                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="slide/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="text1" value='<?php
                                                                                                                        if (!empty($setval)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="text2" value='<?php
                                                                                                                        if (!empty($setval)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="text3" value='<?php
                                                                                                                        if (!empty($setval)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="position" value='<?php
                                                                                                                            if (!empty($setval)) {
