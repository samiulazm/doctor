            ...
            <div class="panel-body">
                ...
                <form role="form" action="meeting/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="<?php echo lang('meeting'); ?> <?php echo lang('topic'); ?>" class="form-control form-control-lg" value="<?php
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9">
                            <input type="number" placeholder="Meeting Duration" class="form-control form-control-lg" name="duration" value="<?php
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-9">
                            <input type="password" placeholder="<?php echo lang('meeting_password'); ?>" class="form-control form-control-lg" name="meeting_password" value="<?php
