    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-video mr-2"></i><?php echo lang('meetings'); ?> <?php echo lang('live'); ?> <?php echo lang('now'); ?></h1>
                </div>
                <!-- <div class="col-sm-6">
            ...
            <div class="modal-body row">
                <form role="form" action="meeting/addNew" method="post" class="clearfix" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <select class="form-control form-control-lg m-bot15 doctor_div" id="adoctors" name="doctor" value=''>

                        </select>
                    </div>
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('zoom'); ?> <?php echo lang('meeting_id'); ?></label>
                        <input type="text" class="form-control form-control-lg" name="meeting_id" value='' placeholder="">
                    </div>
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('zoom'); ?> <?php echo lang('meeting_password'); ?> </label>
                        <input type="text" class="form-control form-control-lg" name="meeting_password" value='' placeholder="">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editMeetingForm" action="meeting/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('doctor'); ?></label>
                        <select class="form-control form-control-lg m-bot15 doctor doctor_div1" id="adoctors1" name="doctor" value=''>
