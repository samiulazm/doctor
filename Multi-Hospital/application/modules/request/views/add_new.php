                ...
                <div class="adv-table editable-table ">
                    ...
                    <form role="form" action="request/addNew" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-lg m-bot15 pos_select" id="pos_select" name="package" value='' required="">
                                <option value=""> - - - </option>
                                <option value="" <?php
                                                    if (!empty($request->id)) {
                        ...
                        <div class="form-group pos_client">
                            ...
                            <input type="text" class="form-control form-control-lg" name="p_limit" id="exampleInputEmail1" value='<?php
                        ...
                        <div class="form-group pos_client">
                            ...
                            <input type="text" class="form-control form-control-lg" name="d_limit" id="exampleInputEmail1" value='<?php
