    ...
    <section class="content-header <?php echo $ap_settings_saas_ui ? 'ap-settings-saas-hero shadow-none border-0 py-4' : ''; ?>">
        <div class="container-fluid">
            ...
            <div class="row align-items-center pl-1">
                <div class="col-12 col-lg-9">
                    ...
                    <h1 class="display-4 font-weight-black mb-0">
                        <i class="fas fa-user-md mr-2 ap-settings-saas-report-hero-icon"></i><?php echo lang('registered_doctor'); ?>
                    </h1>
                    <nav aria-label="breadcrumb" class="mt-2">
                        <ol class="breadcrumb bg-transparent mb-0">
                            <li class="breadcrumb-item"><a href="home"><?php echo lang('home'); ?></a></li>
                            <li class="breadcrumb-item"><?php echo lang('report-h'); ?></li>
                            <li class="breadcrumb-item active"><?php echo lang('registered_doctor'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row my-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i class="fas fa-user-md mr-2"></i><?php echo lang('registered_doctor'); ?></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card <?php echo $ap_settings_saas_ui ? 'ap-settings-saas-systems-report border-0 shadow' : ''; ?>">
                        <div class="card-header <?php echo $ap_settings_saas_ui ? 'ap-settings-saas-systems-card-hd' : ''; ?>">
                            <h3 class="card-title mb-0"><?php echo lang('All the doctor information from all the hospitals'); ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
