            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h1 class="display-4 font-weight-black mb-0">
                        ...
                        <?php echo date('Y', $first_minute) . ' ' . lang('hospital') . ' ' . lang('sales_report'); ?>
                    </h1>
                ...
                <div class="col-sm-6 text-right">
                    ...
                    ?>
                    <a href="finance/monthly?year=<?php echo $previous_year; ?>" class="btn btn-warning btn-sm px-4 py-3 mr-2">
                        <i class="fa fa-arrow-left"></i> <?php echo lang('previous_year'); ?>
                    </a>
                    <a href="finance/monthly?year=<?php echo $next_year; ?>" class="btn btn-success btn-sm px-4 py-3 mr-2">
                ...
                <div class="col-md-8">
                    <div class="card shadow-lg border-0">
                        <div class="card-header">
                            <h3 class="card-title text-black font-weight-800"><?php echo date('Y', $first_minute) . ' ' . lang('hospital') . ' ' . lang('sales_report'); ?></h3>
                        </div>
